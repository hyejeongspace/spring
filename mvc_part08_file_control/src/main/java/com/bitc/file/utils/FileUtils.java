...
public class FileUtils {
	...
	public static byte[] getBytes(
		...
		length = is.available();	//입력스트림에서 연결된 파일에서 아직 읽지 않는 파일의 크기(현재 전체 크기)
	...
	public static HttpHeaders getOctetHeaders(String fileName) throws UnsupportedEncodingException {
		...
		// 해석할 수 없는 파일로 브라우저가 인식하여 다운로드 하게 됨. 
		...
		// attachment : 부착, 첨부물 (=첨부파일) 
		// attachment;fileName= 다운로드 받을 때 사용할 이름
		// utf-8 형식의 파일 이름을 url에서 인식할 수 있도록 ISO-8859-1로 변경
		/*
